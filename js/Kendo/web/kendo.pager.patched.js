...
(function (f, define) {
    ...
    (function ($, undefined) {
    	// patch appied by Corrigo devs.
    	// it's related to https://jira.qa.corrigo.com:55445/browse/CN-11451
		// it should be removed after next upgrade, because it's already fixed in next release of Kendo UI
    	//original line: var kendo = window.kendo, ui = kendo.ui, Widget = ui.Widget, proxy = $.proxy, FIRST = '.k-i-seek-w', LAST = '.k-i-seek-e', PREV = '.k-i-arrow-w', NEXT = '.k-i-arrow-e', CHANGE = 'change', NS = '.kendoPager', CLICK = 'click', KEYDOWN = 'keydown', DISABLED = 'disabled', iconTemplate = kendo.template('<a href="\\#" aria-label="#=text#" class="k-link k-pager-nav #= wrapClassName #"><span class="k-icon #= className #"></span></a>');
