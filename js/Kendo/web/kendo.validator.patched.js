        ...
        var Validator = Widget.extend({
            ...
            options: {
                ...
                messages: {
                	...
                	///////////////////////////////////////////////////////////////////
                	// start of patch by Corrigo (multi-part)
                	// add time validator to Kendo Validator
					, time: "{0} is not valid time"
                	// start of patch by Corrigo
                	///////////////////////////////////////////////////////////////////
                },
                rules: {
                	...
                	// add time validator to Kendo Validator
					, time: function (input) {
						if (input.filter("[type^=time],[" + kendo.attr("type") + "=time]").length && input.val() !== "") {
							return kendo.parseDate(input.val(), input.attr(kendo.attr("format"))) !== null;
						}
						return true;
					}
