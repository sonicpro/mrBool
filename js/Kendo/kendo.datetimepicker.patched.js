        ...
        var DateTimePicker = Widget.extend({
            ...
            _editable: function (options) {
                ...
                if (!readonly && !disable) {
					...
					/////////////////////////////////////////////////////////////////////////////////////////////////
					// Start of the code changed (patched) by Corrigo developers
					//
					// The anonymous function handling the "blur" event was converted to the "_blur" method because
					// it needs to be overridden in the "CorrigoDateTimePicker" class. Similar changes are not
					// required for the "DatePicker" and "TimePicker" classes because they, as opposed to the
					// "DateTimePicker" class, already have separate "_blur" methods instead of anonymous functions.
                	...
                	//                    });
                	//
                	// End of the code changed by Corrigo developers
                	/////////////////////////////////////////////////////////////////////////////////////////////////
        	...
        	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        	// Start of the code added (patch) by Corrigo developers (mutli-part)
        	//
        	// The "_blur" method was extracted from the "_editable" method because it needs to be overridden in the
        	// "CorrigoDateTimePicker" class. Similar changes are not required for the "DatePicker" and "TimePicker" classes
        	// because they, as opposed to the "DateTimePicker" class, already have separate "_blur" methods instead of
        	// anonymous functions.
            _blur: function () {
            	var that = this;
        	...
        	// End of the code added by Corrigo developers
        	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
