    ...
    (function ($, window, undefined) {
        ...
        (function () {
            ...
            function parseExact(value, format, culture) {
            	...
            	// We want to make parseExact really exact. Particluarly we want
            	// kendo.parseDate('02/29/2013',['MM/dd/yyyy','MM/dd/yy'])
            	// to be null instead of "February 29, 2020"
            	// Currently kendo just checks that there is enough data in the "value" to match the "format".
            	// However if there is some leftover in the "value" is it just ignored.
            	// So
            	// kendo.parseDate('02/29/2013',['MM/dd/yyyy','MM/dd/yy'])
            	// is the same as
            	// kendo.parseDate('02/29/2013','MM/dd/yy')
            	// which is the same as ("13" is ignored!)
            	// kendo.parseDate('02/29/20','MM/dd/yy')
            	//
            	// Current idea of the fix is to check that value is fully parsed and if there is any
            	// leftover treat is as a failure to parse.
                if (valueIdx != value.length)
                	return null;
            	// end of the patch by Corrigo (single-part)
            	///////////////////////////////////////////////////////////////////////////////////
        ...
        function getOffset(element, type, positioned) {
        	...
        	/* patch by Corrigo devs.
			/* this code is already removed in latest kendo build
			/* it breaks positioning of dropdown's list-part on android
			/* more info - https://jira.qa.corrigo.com:55445/browse/CN-11471
			/* should be removed totally after next upgrade
